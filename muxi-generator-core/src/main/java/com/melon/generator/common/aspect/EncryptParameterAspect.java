package com.melon.generator.common.aspect;

import com.melon.generator.common.page.PageResult;
import com.melon.generator.common.utils.EncryptUtils;
import com.melon.generator.common.utils.Result;
import lombok.extern.slf4j.Slf4j;
import com.melon.generator.common.annotation.EncryptParameter;
...
public class EncryptParameterAspect {
     ...
     * @throws Throwable
     */
    @Around("execution(* com.melon.generator.controller.DataSourceController.*(..))")
    ...
    private void handleItem(Object item, boolean isDecrypt) {
        ...
        // 只处理在entity包下面的对象
        if (Objects.isNull(item.getClass().getPackage()) || !item.getClass().getPackage().getName().startsWith("com.melon.generator.entity")) {
            return;
        }
